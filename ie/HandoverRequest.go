...
Nasc	NasPdu	//`bitstring:"sizeLB:0,sizeUB:150"`
PduSessionResourceSetupList	[]PduSessionResourceSetupItem	//`bitstring:"sizeLB:0,sizeUB:150"`
...
HandoverRequestTransfer	aper.OctetString	//`octetstring:"sizeLB:0,sizeUB:150"`
