...
type PDUSessionResourceReleasedItemPSFail struct {
	...
	// IEExtensions  *PDUSessionResourceReleasedItemPSFailExtIEs
}
...
func (ie *PDUSessionResourceReleasedItemPSFail) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_PathSwitchRequestUnsuccessfulTransfer := NewOCTETSTRING(ie.PathSwitchRequestUnsuccessfulTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
