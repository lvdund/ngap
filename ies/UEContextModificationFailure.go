...
func (msg *UEContextModificationFailure) Encode(w io.Writer) (err error) {
	return encodeMessage(w, NgapPduUnsuccessfulOutcome, ProcedureCode_UEContextModification, Criticality_PresentReject, msg.toIes())
}
func (msg *UEContextModificationFailure) toIes() (ies []NgapMessageIE) {
	ies = []NgapMessageIE{}
