...
type PDUSessionResourceFailedToSetupItemPSReq struct {
	...
	// IEExtensions  *PDUSessionResourceFailedToSetupItemPSReqExtIEs
}
...
func (ie *PDUSessionResourceFailedToSetupItemPSReq) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_PathSwitchRequestSetupFailedTransfer := NewOCTETSTRING(ie.PathSwitchRequestSetupFailedTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
