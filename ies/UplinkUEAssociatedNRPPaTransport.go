...
func (msg *UplinkUEAssociatedNRPPaTransport) toIes() (ies []NgapMessageIE, err error) {
	ies = []NgapMessageIE{}
...
type UplinkUEAssociatedNRPPaTransportDecoder struct {
	msg      *UplinkUEAssociatedNRPPaTransport
	diagList []CriticalityDiagnosticsIEItem
	list     map[aper.Integer]*NgapMessageIE
}

func (decoder *UplinkUEAssociatedNRPPaTransportDecoder) decodeIE(r *aper.AperReader) (msgIe *NgapMessageIE, err error) {
	var id int64
	var c uint64
	var buf []byte
