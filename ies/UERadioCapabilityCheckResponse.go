...
func (msg *UERadioCapabilityCheckResponse) toIes() (ies []NgapMessageIE) {
	...
	if msg.IMSVoiceSupportIndicator != nil {
		ies = append(ies, NgapMessageIE{
...
func (msg *UERadioCapabilityCheckResponse) Decode(wire []byte) (err error, diagList []CriticalityDiagnostics) {
...
func (msg *UERadioCapabilityCheckResponse) decodeIE(r *aper.AperReader) (msgIe *NgapMessageIE, err error) {
