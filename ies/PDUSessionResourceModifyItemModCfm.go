...
type PDUSessionResourceModifyItemModCfm struct {
	...
	// IEExtensions  *PDUSessionResourceModifyItemModCfmExtIEs
}
...
func (ie *PDUSessionResourceModifyItemModCfm) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_PDUSessionResourceModifyConfirmTransfer := NewOCTETSTRING(ie.PDUSessionResourceModifyConfirmTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
