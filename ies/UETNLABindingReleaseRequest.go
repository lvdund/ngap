...
func (msg *UETNLABindingReleaseRequest) Decode(wire []byte) (err error, diagList []CriticalityDiagnostics) {
...
func (msg *UETNLABindingReleaseRequest) decodeIE(r *aper.AperReader) (msgIe *NgapMessageIE, err error) {
