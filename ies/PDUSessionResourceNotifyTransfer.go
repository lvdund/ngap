...
type PDUSessionResourceNotifyTransfer struct {
	...
	QosFlowReleasedList *[]QosFlowWithCauseItem
	// IEExtensions  *PDUSessionResourceNotifyTransferExtIEs
}
...
func (ie *PDUSessionResourceNotifyTransfer) Decode(r *aper.AperReader) (err error) {
	...
	if aper.IsBitSet(optionals, 1) {
		...
		if err = tmp_QosFlowNotifyList.Decode(r); err != nil {
			return
		}
	...
	if aper.IsBitSet(optionals, 2) {
		...
		if err = tmp_QosFlowReleasedList.Decode(r); err != nil {
			return
		}
