...
type PDUSessionResourceFailedToSetupItemHOAck struct {
	...
	// IEExtensions  *PDUSessionResourceFailedToSetupItemHOAckExtIEs
}
...
func (ie *PDUSessionResourceFailedToSetupItemHOAck) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_HandoverResourceAllocationUnsuccessfulTransfer := NewOCTETSTRING(ie.HandoverResourceAllocationUnsuccessfulTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
