...
func (msg *HandoverNotify) Decode(wire []byte) (err error, diagList []CriticalityDiagnostics) {
...
func (msg *HandoverNotify) decodeIE(r *aper.AperReader) (msgIe *NgapMessageIE, err error) {
