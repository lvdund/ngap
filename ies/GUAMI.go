...
func (ie *GUAMI) Decode(r *aper.AperReader) (err error) {
	...
	if err = tmp_AMFRegionID.Decode(r); err != nil {
		err = fmt.Errorf("Read AMFRegionID: %w", err)
		return
	}
	...
	if err = tmp_AMFPointer.Decode(r); err != nil {
		err = fmt.Errorf("Read AMFPointer: %w", err)
		return
	}
