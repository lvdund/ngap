...
type PDUSessionResourceModifyItemModInd struct {
	...
	// IEExtensions  *PDUSessionResourceModifyItemModIndExtIEs
}
...
func (ie *PDUSessionResourceModifyItemModInd) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_PDUSessionResourceModifyIndicationTransfer := NewOCTETSTRING(ie.PDUSessionResourceModifyIndicationTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
