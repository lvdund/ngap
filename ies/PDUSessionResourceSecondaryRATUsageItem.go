...
type PDUSessionResourceSecondaryRATUsageItem struct {
	...
	// IEExtensions  *PDUSessionResourceSecondaryRATUsageItemExtIEs
}
...
func (ie *PDUSessionResourceSecondaryRATUsageItem) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_SecondaryRATDataUsageReportTransfer := NewOCTETSTRING(ie.SecondaryRATDataUsageReportTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
