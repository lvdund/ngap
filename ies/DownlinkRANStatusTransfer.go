...
func (msg *DownlinkRANStatusTransfer) Encode(w io.Writer) (err error) {
	return encodeMessage(w, NgapPduInitiatingMessage, ProcedureCode_DownlinkRANStatusTransfer, Criticality_PresentIgnore, msg.toIes())
}
func (msg *DownlinkRANStatusTransfer) toIes() (ies []NgapMessageIE) {
	ies = []NgapMessageIE{}
