...
type PDUSessionResourceToReleaseItemRelCmd struct {
	...
	// IEExtensions  *PDUSessionResourceToReleaseItemRelCmdExtIEs
}
...
func (ie *PDUSessionResourceToReleaseItemRelCmd) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_PDUSessionResourceReleaseCommandTransfer := NewOCTETSTRING(ie.PDUSessionResourceReleaseCommandTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
