...
func (msg *RRCInactiveTransitionReport) Decode(wire []byte) (err error, diagList []CriticalityDiagnostics) {
...
func (msg *RRCInactiveTransitionReport) decodeIE(r *aper.AperReader) (msgIe *NgapMessageIE, err error) {
	var id int64
	var c uint64
	var buf []byte
