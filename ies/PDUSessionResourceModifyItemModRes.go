...
type PDUSessionResourceModifyItemModRes struct {
	...
	// IEExtensions  *PDUSessionResourceModifyItemModResExtIEs
}
...
func (ie *PDUSessionResourceModifyItemModRes) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_PDUSessionResourceModifyResponseTransfer := NewOCTETSTRING(ie.PDUSessionResourceModifyResponseTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
