...
func (msg *HandoverPreparationFailure) Decode(wire []byte) (err error, diagList []CriticalityDiagnostics) {
...
func (msg *HandoverPreparationFailure) decodeIE(r *aper.AperReader) (msgIe *NgapMessageIE, err error) {
