...
type PDUSessionResourceFailedToModifyItemModRes struct {
	...
	// IEExtensions  *PDUSessionResourceFailedToModifyItemModResExtIEs
}
...
func (ie *PDUSessionResourceFailedToModifyItemModRes) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_PDUSessionResourceModifyUnsuccessfulTransfer := NewOCTETSTRING(ie.PDUSessionResourceModifyUnsuccessfulTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
