...
type PDUSessionResourceAdmittedItem struct {
	...
	// IEExtensions  *PDUSessionResourceAdmittedItemExtIEs
}
...
func (ie *PDUSessionResourceAdmittedItem) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_HandoverRequestAcknowledgeTransfer := NewOCTETSTRING(ie.HandoverRequestAcknowledgeTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
