...
type ErrorIndication struct {
	...
	RANUENGAPID            *RANUENGAPID            `,ignore,optional`
	Cause                  *Cause                  `,ignore,optional`
...
func (msg *ErrorIndication) Decode(wire []byte) (err error, diagList []CriticalityDiagnostics) {
...
func (msg *ErrorIndication) decodeIE(r *aper.AperReader) (msgIe *NgapMessageIE, err error) {
