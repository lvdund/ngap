...
type PDUSessionResourceReleasedItemNot struct {
	...
	// IEExtensions  *PDUSessionResourceReleasedItemNotExtIEs
}
...
func (ie *PDUSessionResourceReleasedItemNot) Encode(w *aper.AperWriter) (err error) {
	...
	tmp_PDUSessionResourceNotifyReleasedTransfer := NewOCTETSTRING(ie.PDUSessionResourceNotifyReleasedTransfer, aper.Constraint{Lb: 0, Ub: 0}, true)
